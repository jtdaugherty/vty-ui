...
rendering context.  Widgets provide an API for setting these
attributes using the \fw{HasNormalAttr} and \fw{HasFocusAttr} type
classes.  The reason we use type classes to provide this API is so
that third-party widgets may also provide this functionality.  The API
is defined in the \fw{Core} module and is as follows:
