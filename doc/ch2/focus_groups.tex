...
\fw{Dialog} must create their own \fw{FocusGroup}s to provide coherent
...
(\fw{DirBrowser}, see Section XXX).  You might want to place this
alongside other widgets that should also accept input.  When you
create the \fw{DirBrowser} widget, you will get a reference to the
widget and a reference to its \fw{FocusGroup}:
