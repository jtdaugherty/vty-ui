...
in the demonstration in Section \ref{sec:gettingStarted}, we used
then \fw{centered} function to center an edit widget.  The result was
a \fw{Centered} widget, which is one of the many built-in container
