...
The following example demonstrates the handling of all three types of
events:
...
\item \fw{setEditMaxLength} -- sets the maximum number of characters
  in the \fw{Edit} widget.  Once set, the limit cannot be removed but
  it can be changed to a different value.  If \fw{setEditMaxLength} is
