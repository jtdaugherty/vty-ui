...
As described in Section \ref{sec:new_widget_type}, the \fw{render\_}
function is responsible for converting a widget's internal state into
an \fw{Image} to be displayed in the terminal.  This function is
...
\fw{render} function provided by the \fw{Core} module.  This function
